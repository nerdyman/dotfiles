...
brew install awscli bat bat-extras coreutils fnm fzf gnu-tar grc git git-delta htop inetutils jq neovim prettier ripgrep shellcheck starship tree zsh zsh-syntax-highlighting zstd
