...
brew install awscli bandwhich bash-completion bat bat-extras coreutils ctop fnm fx fzf gnu-tar grc git git-delta htop inetutils jq neovim prettier progress ripgrep shellcheck starship tree zsh zsh-syntax-highlighting zstd
